    ...
    <div className="font-jost">
      ...
      <section className="py-20 bg-white" ref={teamRef}>
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold text-gray-800 mb-6">Leadership Team</h2>
          ...
          <motion.div
            className="grid grid-cols-1 mx-auto md:grid-cols-3 gap-10"
                  ...
                  <div className="relative">
                    {member.id === 1 || member.id === 3 ? (
                      <div className="relative h-[300px] overflow-hidden">
                        ...
                        />
                        <div
                          className={`absolute inset-0 bg-gradient-to-r from-blue-900 to-teal-900 transition-opacity duration-500 flex flex-col items-center justify-center p-8 text-white text-center ${
                      ...
                      <div className="h-[400px] bg-gradient-to-r from-blue-900 to-teal-900 p-8 flex flex-col items-center justify-center text-white text-center">
                        <h3 className="text-2xl font-bold mb-6">{member.name}</h3>
                        <img
                          src={member.image || "/placeholder.svg"}
                          alt={member.name}
                          className="w-40 h-34 rounded-full object-cover mx-auto border-4 border-white/30"
                        />
                      </div>
                    )}
                  </div>
      ...
      <section className="py-20 bg-gray-50" ref={supportTeamRef}>
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold text-gray-800 mb-6">Our Team</h2>
            <div className="w-24 h-1 bg-teal-500 mx-auto mb-8"></div>
            <p className="text-lg text-gray-700">
            ...
            {supportTeam.map((member) => (
              ...
              >
                <div className="flex flex-col sm:flex-row md:flex-col">
                  <div className="sm:w-1/3 md:w-full h-34 md:h-48 overflow-hidden relative">
